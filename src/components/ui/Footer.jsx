    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-teal-600 sm:justify-start dark:text-teal-300">
          <img width={90} className='rounded-full' src="/WheelVibe.png" alt="" />
        </div>

        <p
          className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400"
        >
          Looking for a new, used, or pre-owned car? We make it easy to find, compare, and buy your next ride—hassle-free and reliable.
        </p>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="flex-1 text-gray-700 dark:text-gray-300"> khandagalemanish@gmail.com </span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 text-gray-700 dark:text-gray-300">1234567890</span>
              </a>
            </li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          <span className="block sm:inline">All rights reserved @WheelVibe .</span>
